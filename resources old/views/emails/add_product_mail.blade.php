        ...
        <tr>
            <td align="center">
                <table class="container" width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; width: 600px;">
                    ...
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <h2 style="font-size: 20px; color: #333333;">New Product</h2>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="padding: 10px;" class="stack-column">
                                        <p style="font-size: 16px; color: #333333;">Product Name :{{ $product->product_name }}</p>
                                        <p style="font-size: 16px; color: #333333;">Product Quantity : {{ $product->product_quantity }}</p>
                                        <p style="font-size: 16px; color: #333333;">Product Price : {{ $product?->variations->first()?->price ?? 0 }}</p>
                                        <p style="font-size: 16px; color: #333333;">Vendor : {{ $product?->vendor?->user?->username ?? '' }}</p>
                                    </td>
                                    <td align="center" style="padding: 10px;" class="stack-column">
                                        <img src="https://siostore.eu/uploads/images/product/{{ $product->product_thumbnail }}" alt="Product 1" style="width: 150px;" class="responsive-img">
                                    </td>
                    ...
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <h2 style="font-size: 20px; color: #333333;">SPECIAL PRODUCTS</h2>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                @foreach ($data->chunk(4) as $chunk)
                                <tr>
                                    @foreach ($chunk as $item)
                                    <td align="center" style="padding: 10px;" class="stack-column">
                                        <img src="{{ asset('uploads/images/product/000e8dd7d865fce6d097c2be952e838f.jpeg') }}" alt="Product 1" style="width: 150px;" class="responsive-img">
                                        <p style="font-size: 16px; color: #333333;">{{ $item->product_name }}</p>
                                    </td>
                                    @endforeach
                                </tr>
                                @endforeach

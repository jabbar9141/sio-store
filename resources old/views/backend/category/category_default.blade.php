                                                ...
                                                <div class="modal-body">
                                                    <img src="{{ url('uploads/images/category/' . $item->category_image) }}"
                                                        ...
                                                        style="max-width: 300px; margin-left:
                                                         10px">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Category Name : <span
                                                                style="font-weight:
                                                         lighter">{{ $item->category_name }}</span>
                                                        </h5>
                                                        <h5 class="card-title">Category Slug : <span
                                                                style="font-weight:
                                                         lighter">{{ $item->category_slug }}</span>
                                                        </h5>
                                                    </div>
                                                </div>
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="" class="" data-bs-toggle="modal"
                                            data-bs-target="#exampleFullScreenModal-{{ $item->category_id }}"><i
                                                class='bx
                                       bxs-edit'></i></a>
                                                                        ...
                                                                        <div class="col-sm-9 text-secondary">
                                                                            ...
                                                                            <div>
                                                                                <img class="card-img-top"
                                                                                    src="{{ url('uploads/images/category/' . $item->category_image) }}"

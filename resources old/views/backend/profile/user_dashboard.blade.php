                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0 text-white">
                            {{ \App\MyHelpers::fromEuroView(auth()->user()->currency_id, number_format($total_revenue)) }}
                        </h5>
                        <div class="ms-auto">
    ...
    <div class="row">
        <div class="col-12 col-lg-6 col-xl-4 d-flex">
            <div class="card radius-10 overflow-hidden w-100">
                <div class="card-body">
                    <p>Total Spending</p>
                    <h4 class="mb-0">{{ \App\MyHelpers::fromEuroView(auth()->user()->currency_id, number_format($total_revenue)) }}</h4>

...
@section('PageTitle', 'Create Shipping Address')
@section('content')
    <!--breadcrumb -->
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Create Shipping Address</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <form action="{{ route('address.store') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2 form-group">
                            ...
                            <input class="form-control" name="address1" type="text" placeholder="123 Main Street"
                                required>
                        </div>
                        <div class="col-md-6 mb-2 form-group">
                            <label>Address Line 2</label>
                            <input class="form-control" name="address2" type="text" placeholder="Block 1 Suite 2">
                        </div>
                        <div class="col-md-6 mb-2 form-group">
                        ...
                        <div class="col-md-6 mb-2 form-group">
                            ...
                            <input class="form-control" type="text" name="zip" placeholder="12300" required>
                        </div>

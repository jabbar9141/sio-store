...
@section('content')
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
        ...
        <div class="col">
            <div class="card radius-10 bg-gradient-orange">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h5 class="mb-0 text-white">{{\App\MyHelpers::fromEuroView(auth()->user()->currency_id, number_format($total_revenue)) }}</h5>
                        <div class="ms-auto">
    ...
    <div class="row">
        <div class="col-12 col-lg-6 col-xl-4 d-flex">
            <div class="card radius-10 overflow-hidden w-100">
                <div class="card-body">
                    <p>Total Spending</p>
                    <h4 class="mb-0">&euro;{{ number_format($total_revenue) }}</h4>
        ...
        <div class="col-12 col-lg-6 col-xl-8 d-flex">
            <div class="card radius-10 w-100">
                <div class="card-header border-bottom bg-transparent">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">My Latest Reviews</h6>
                        </div>
                            ...
                            <div class="row d-flex justify-content-between">
                                <div class="col-sm-1">
                                    <img src="{{ !empty($r->user->photo)
                                        ...
                                        alt="Image" class="img-fluid mr-3 mt-1" alt="user avatar" class="rounded-circle"
                                        width="55" height="55">
                                </div>
                                <div class="col-sm-8">
                                    <div class="ms-3">
                                        ...
                                        <p class="mb-0 small-font">{{ '@' . $r->user->username }} : {{ $r->comment }}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-sm-3">
    ...
    <div class="card radius-10">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div>
                    <h5 class="mb-0">My Latest Orders Summary</h5>
                </div>
                <div class="font-22 ms-auto"><i class="bx bx-dots-horizontal-rounded"></i>
                </div>
            </div>
                        ...
                        @if (isset($orders_list) && count($orders_list) > 0)
                            @foreach ($orders_list as $order)
                                <tr>
                                    ...
                                    <td>
                                        <div class="badge rounded-pill bg-secondary text-info w-100">{{$order->status}}</div>
                                    </td>
                                </tr>
                            @endforeach
                        @else

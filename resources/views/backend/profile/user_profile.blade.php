                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <form id="profile_image" method="POST" action="{{ route('user-profile-image-update') }}"
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            <form id="info_form" action="{{ route('user-profile-info-update') }}" method="POST">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select class="form-control" id="currency" name="currency_id">
                                            ...
                                            @else
                                                <option value="0" selected>Global</option>
                                                @foreach ($curriencies as $currency)
                                                    <option value="{{ $currency->id }}" @selected($data->currency_id == $currency->id ? true : false)>
                                                        {{ $currency->country }} ({{ $currency->country_code }})</option>
                                                @endforeach
                                            @endif
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form id="password_form" action="{{ route('user-profile-password-update') }}"
                                        method="POST">
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#info_form').on('submit', function(event) {
                ...
                $.ajax({
                    url: "{{ route('user-profile-info-update') }}",
                    method: 'POST',

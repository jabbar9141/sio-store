...
@section('content')
    ...
    <div class="container-fluid px-xl-5 help-section">
        ...
        <p>Updated at April 19th, 2024</p>
        <h2>General Terms</h2>
        <p>
            By accessing and placing an order with siostore, you confirm that you are in agreement with and bound by
            the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire
            website and any email or other type of communication between you and siostore.
            <br>
            <br>
            Under no circumstances shall siostore team be liable for any direct, indirect, special, incidental or
            consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the
            inability to use, the materials on this site, even if siostore team or an authorized representative has been
            ...
            <br><br>
            siostore will not be responsible for any outcome that may occur during the course of usage of our resources.
            We reserve the rights to change prices and revise the resources usage policy in any moment.
        </p>
        <h2>License</h2>
        <p>
            siostore grants you a revocable, non-exclusive, non-transferable, limited license to download, install and use
            the website/app strictly in accordance with the terms of this Agreement.
            These Terms & Conditions are a contract between you and siostore (referred to in these Terms & Conditions
            as "siostore", "us", "we" or "our"), the provider of the siostore website and the services accessible from the
            siostore website (which are collectively referred to in these Terms & Conditions as the "siostore Service").
            <br>
            You are agreeing to be bound by these Terms & Conditions. If you do not agree to these Terms &
            Conditions, please do not use the siostore Service. In these Terms & Conditions, "you" refers both to you as
        ...
        <ul>
            ...
            <li>Company: when this terms mention “Company,” “we,” “us,” or “our,” it refers to SIOPAY MULTISERVIZI
                SRL, (PIAZZA PORCELLI SNC LAMEZIA TERME CZ), that is responsible for your information under
                this Terms & Conditions.</li>
            <li>
            ...
            <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can
                be used to visit siostore and use the services.</li>
            <li>Service: refers to the service provided by siostore as described in the relative terms (if available) and on
                this platform.</li>
            ...
            <li>You: a person or entity that is registered with siostore to use the Services.
                This Terms & Conditions were created with Termify.</li>
        </ul>
        <h2>Restrictions</h2>
        ...
        <p>
            ...
            with respect to your Payment Provider. By providing siostore with your credit card number and associated
            payment information, you agree that siostore is authorized to verify information immediately, and
            subsequently invoice your account for all fees and charges due and payable to siostore hereunder and that
            no additional notice or consent is required. You agree to immediately notify siostore of any change in your
            billing address or the credit card used for payment hereunder. siostore reserves the right at any time to
            ...
            <br><br>
            No contract will exist between you and siostore for the Service until siostore accepts your order by a
        ...
        <p>
            Thanks for shopping at siostore. We appreciate the fact that you like to buy the stuff we build. We also want
            to make sure you have a rewarding experience while you’re exploring, evaluating, and purchasing our
            products
            <br><br>
            As with any shopping experience, there are terms and conditions that apply to transactions at siostore. We’ll
        ...
        <p>
            ...
            to siostore with respect to the website/app shall remain the sole and exclusive property of siostore.
            siostore shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose and in
        ...
        <p>This Terms & Conditions applies only to the Services. The Services may contain links to other websites not
            operated or controlled by siostore. We are not responsible for the content, accuracy or opinions expressed in
        ...
        <h2>Cookies</h2>
        <p>siostore uses "Cookies" to identify the areas of our website/app that you have visited. A Cookie is a small
        ...
        <p>
            You acknowledge and agree that siostore may stop (permanently or temporarily) providing the Service (orpage 4/10
            any features within the Service) to you or to users generally at siostore’s sole discretion, without prior
            notice
            to you. You may stop using the Service at any time. You do not need to specifically inform siostore when you
            stop using the Service. You acknowledge and agree that if siostore disables access to your account, you
        ...
        <p>
            siostore reserves the right to modify, suspend or discontinue, temporarily or permanently, the website/app or
        ...
        <p>siostore may from time to time provide enhancements or improvements to the features/ functionality of the
            ...
            siostore has no obligation to (i) provide any Updates, or (ii) continue to provide or enable any particular
            features and/or functionalities of the website/app to you.
            You further agree that all Updates will be (i) deemed to constitute an integral part of the website/app, and
            (ii)
        ...
        <p>We may display, include or make available third-party content (including data, information, applications and
            ...
            You acknowledge and agree that siostore shall not be responsible for any Third-Party Services, including
            their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any
            other aspect thereof. siostore does not assume and shall not have any liability or responsibility to you or any
        ...
        <p>This Agreement shall remain in effect until terminated by you or siostore.
            siostore may, in its sole discretion, at any time and for any or no reason, suspend or terminate thispage 5/10
            Agreement with or without prior notice.
            This Agreement will terminate immediately, without prior notice from siostore, in the event that you fail to
            ...
            Termination of this Agreement will not limit any of siostore's rights or remedies at law or in equity in case of
        ...
        <p>If you are a copyright owner or such owner’s agent and believe any material on our website/app constitutes
        ...
        <h2>No Warranties</h2>
        <p>The website/app is provided to you "AS IS" and "AS AVAILABLE" and with all faults and defects without
            ...
            Without limiting the foregoing, neither siostore nor any siostore's provider makes any representation or
            ...
            or on behalf of siostore are free of viruses, scripts, trojan horses, worms, malware, timebombs or other
            harmful components.
        ...
        <p>Notwithstanding any damages that you might incur, the entire liability of siostore and any of its suppliers
        ...
        <p>If any provision of this Agreement is held to be unenforceable or invalid, such provision will be changed and
            ...
            This Agreement, together with the Privacy Policy and any other legal notices published by siostore on the
            Services, shall constitute the entire agreement between you and siostore concerning the Services. If any
            ...
            such term or any other term, and siostore’s failure to assert any right or provision under this Agreement shall
        ...
        <p>siostore reserves the right, at its sole discretion, to modify or replace this Agreement at any time. If a
            ...
            by the revised terms. If you do not agree to the new terms, you are no longer authorized to use siostore.
        </p>
        <h2>Entire Agreement</h2>
        <p>The Agreement constitutes the entire agreement between you and siostore regarding your use of the
        ...
        <p>The website/app and its entire contents, features and functionality (including but not limited to all
            information,
            software, text, displays, images, video and audio, and the design, selection and arrangement thereof), are
            owned by siostore, its licensors or other providers of such material and are protected by ITALY and
            ...
            or in part, without the express prior written permission of siostore, unless and except as is expressly provided
        ...
        <p>This section applies to any dispute EXCEPT IT DOESN’T INCLUDE A DISPUTE RELATING TO CLAIMS
            ...
            OR siostore’s INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute, action, or other
            controversy between you and siostore concerning the Services or this agreement, whether in contract,
            warranty, tort, statute, regulation, ordinance, or any other legal or equitable basis. “Dispute” will be given
            the
            broadest possible meaning allowable under law.</p>
        <h2>Notice of Dispute</h2>
        <p>In the event of a dispute, you or siostore must give the other a Notice of Dispute, which is a written statement
            that sets forth the name, address, and contact information of the party giving it, the facts giving rise to the
            dispute, and the relief requested. You must send any Notice of Dispute via email to: support@siostore.eu.
            siostore will send any Notice of Dispute to you by mail to your address if we have it, or otherwise to your
            email address. You and siostore will attempt to resolve any dispute through informal negotiation within sixty
            (60) days from the date the Notice of Dispute is sent. After sixty (60) days, you or siostore may commence
            arbitration.</p>
        <h2>Binding Arbitration</h2>
        <p>If you and siostore don’t resolve any dispute by informal negotiation, any other effort to resolve the dispute
        ...
        <p>In the event that you submit or post any ideas, creative suggestions, designs, photographs, information,
            ...
            non-confidential and non-proprietary and will become the sole property of siostore without any compensation
            or credit to you whatsoever. siostore and its affiliates shall have no obligations with respect to such
        ...
        <h2>Promotions</h2>
        <p>
            siostore may, from time to time, include contests, promotions, sweepstakes, or other activities (“Promotions”)
        ...
        <p>If for any reason a court of competent jurisdiction finds any provision or portion of these Terms & Conditions
            ...
            authorized representative of siostore. siostore will be entitled to injunctive or other equitable relief
            (without
            the obligations of posting any bond or surety) in the event of any breach or anticipatory breach by you.
            siostore operates and controls the siostore Service from its offices in ITALY. The Service is not intended for
            distribution to or use by any person or entity in any jurisdiction or country where such distribution or use
            would be contrary to law or regulation. Accordingly, those persons who choose to access the siostore
            ...
            the siostore Privacy Policy) contains the entire understanding, and supersedes all prior understandings,
            between you and siostore concerning its subject matter, and cannot be changed or modified by you. The

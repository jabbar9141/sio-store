        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    ...
                    <hr>
                    <button type="submit" class="btn btn-primary" {{ count($products) < 1 ? 'disabled' : '' }}>Apply
                        Filter</button>
                </div>
...
<img class="img-fluid img-thumbnail w-100" src="/uploads/images/product/{{ $product->images[0]->product_image }}" alt="">
@else
<img class="img-fluid img-thumbnail w-100" alt="{{ $product->product_name }}">
@endif -->
                                                    <!-- <div class="product-action">
                                                <a class="btn btn-outline-dark btn-square" href="{{ route('store.showProduct', $product->product_slug) }}">
                                                    ...
                                                    <div class="product-card-img-1">
                                                        <div class="product-card-img-1">
                                                            @if (!empty($product->images) && isset($product->images[0]))
                                                                <img src="/uploads/images/product/{{ $product->images[0]->product_image }}"
                                                                    alt="" class="h-100 w-100">
                                                            @else
                                                                @if ($product->product_thumbnail)
                                                                    <img src="/uploads/images/product/{{ $product->product_thumbnail }}"
                                                                        alt="" class="h-100 w-100">
                                                                @else
                                                                    <img src="/uploads/images/product/0826d25041400d65bf9d7d1221b978ed.jpg"
                                                                        alt="Default Image" class="h-100 w-100">
                                                                @endif
                                                            @endif
                                                            {{-- <img src="/uploads/images/product/{{ $product->images[0]->product_image }}" alt="" class="h-100 w-100"> --}}

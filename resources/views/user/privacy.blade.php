...
@section('content')
    ...
    <div class="container-fluid px-xl-5 help-section">
        ...
        <p>siostore (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your
            personal information is collected, used, and disclosed by siostore.
            This Privacy Policy applies to our website/app, and its associated subdomains (collectively, our “Service”)
            alongside our application, siostore. By accessing or using our Service, you signify that you have read,
        ...
        <ul>
            ...
            <li>
                ...
                MULTISERVIZI SRL, (PIAZZA PORCELLI LAMEZIA TERME CZ ITALY ), that is responsible for your
            ...
            <li>Customer: refers to the company, organization or person that signs up to use the siostore Service to
            ...
            <li>
                Personnel: refers to those individuals who are employed by siostore or are under contract to perform a
            ...
            <li>
                Service: refers to the service provided by siostore as described in the relative terms (if available) and on
                this platform.
            </li>
            <li>
        ...
        <p>
            ...
            website/app that may include date and time; cookie number; parts of the site you viewed or searched for;
            and the phone number you used to call our Customer Services. We may also use browser data such as
            cookies, Flash cookies (also known as Flash Local Shared Objects) or similar data on certain parts of our
            website/app for fraud prevention and other purposes. During your visits, we may use software tools such as
            JavaScript to measure and collect session information including page response times, download errors,
            length of visits to certain pages, page interaction information (such as scrolling, clicks, and mouse-overs),
            and methods used to browse away from the page. We may also collect technical information to help us
        ...
        <h2>Personnel</h2>
        <p>
            If you are a siostore worker or applicant, we collect information you voluntarily provide to us. We use the
        ...
        <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of
            all or substantially all of the assets of siostore or any of its Corporate Affiliates (as defined herein), or
            that
            portion of siostore or any of its Corporate Affiliates to which the Service relates, or in the event that we
        ...
        <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For
            ...
            controls, is controlled by or is under common control with siostore, whether by ownership or otherwise. Any
        ...
        <h2>Governing Law</h2>
        <p>
            This Privacy Policy is governed by the laws of ITALY without regard to its conflict of laws provision. You
            ...
            laws.
            By using siostore or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not
            agree to this Privacy Policy, you should not engage with our website/app, or use our services. Continued use
            of the website/app, direct engagement with us, or following the posting of changes to this Privacy Policy that
        ...
        <p>
            ...
            visit our site and how it's being used. By using our siostore, registering an account, or making a purchase,
        ...
        <h2>Cookies</h2>
        <p>
            siostore uses "Cookies" to identify the areas of our website/app that you have visited. A Cookie is a small
            ...
            technologies
            Wherever you're located you may also set your browser to block cookies and similar technologies, but thispage
            4/8
        ...
        <h2>Information about General Data Protection</h2>
        <p>
            Regulation (GDPR)
        ...
        <p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that
            ...
            greater fines for breach. Beyond these facts it's simply the right thing to do. At siostore we strongly believe
        ...
        <p>We are committed to helping our customers meet the data subject rights requirements of GDPR. siostore
